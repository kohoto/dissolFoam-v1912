...
// *********************************************************
    ...
    firstCycle ? runTime.writeNow() : runTime.write();  // before this multiply conversion factor and after this divide by conversion factor. check how others deal with this.
    firstCycle = false;
  }
